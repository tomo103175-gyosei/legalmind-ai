    ...
    return (
      <div style={{ maxWidth: "600px", margin: "0 auto" }}>
        <div className="glass-card animate-fade-in" style={{ textAlign: "center" }}>
          <h2>🎉 今日のタスクは完了しました！</h2>
          <p style={{ color: "var(--success-color)", marginBottom: "2rem" }}>今日復習すべき問題はすべて終了しました。</p>
          <a href="/upload" className="btn btn-primary" style={{ width: "100%", maxWidth: "300px", margin: "0 auto" }}>
            新しい問題を登録する
          </a>
        </div>
        
        {/* Schedule shown when caught up */}
